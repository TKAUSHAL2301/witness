# Equivalence certificate — `capital-targets-template::Amortization.A48`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Amortization.A48` |
| Workbook | `capital-targets-template.xlsx` |
| Formula nodes behind it | 53 |
| Free inputs | 1 |
...
| | |
| --- | --- |
| Formula cells in this target's cone | 26 |
| Cells whose value varied across sampling | **26 (100%)** |
