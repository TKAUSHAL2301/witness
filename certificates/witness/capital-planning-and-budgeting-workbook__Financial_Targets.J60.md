# Equivalence certificate — `capital-planning-and-budgeting-workbook::Financial Targets.J60`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Financial Targets.J60` |
| Workbook | `capital-planning-and-budgeting-workbook.xlsx` |
| Formula nodes behind it | 19 |
| Free inputs | 7 |
...
| | |
| --- | --- |
| Formula cells in this target's cone | 5 |
| Cells whose value varied across sampling | **5 (100%)** |
