# Equivalence certificate — `budget-and-tax-rate-planning-tool::Levy Limit.E31`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Levy Limit.E31` |
| Workbook | `budget-and-tax-rate-planning-tool.xlsx` |
| Formula nodes behind it | 43 |
| Free inputs | 4 |
...
| Cells whose value varied across sampling | **3 (60%)** |
| Cells constant for this input domain | 2 |
