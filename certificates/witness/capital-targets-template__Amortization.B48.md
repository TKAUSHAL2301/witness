# Equivalence certificate — `capital-targets-template::Amortization.B48`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Amortization.B48` |
| Workbook | `capital-targets-template.xlsx` |
| Formula nodes behind it | 71 |
| Free inputs | 1 |
...
| | |
| --- | --- |
| Formula cells in this target's cone | 35 |
| Cells whose value varied across sampling | **35 (100%)** |
