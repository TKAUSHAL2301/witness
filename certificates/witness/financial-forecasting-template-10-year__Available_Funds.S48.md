# Equivalence certificate — `financial-forecasting-template-10-year::Available Funds.S48`

## Verdict: **NOT EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Available Funds.S48` |
| Workbook | `financial-forecasting-template-10-year.xlsx` |
| Formula nodes behind it | 35 |
| Free inputs | 1 |
...
- First failing trial: **132**
- Excel returned: `7364`
- The port returned: `7365`
- Difference: **1.00**
- Minimal differing inputs: `Fiscal Years!B13`

Full failing vector:

```json
{
  "Fiscal Years!B13": 1521
}
```
...
| | |
| --- | --- |
| Formula cells in this target's cone | 17 |
| Cells whose value varied across sampling | **17 (100%)** |
