# Equivalence certificate — `appropriation-template::Annual.E31`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Annual.E31` |
| Workbook | `appropriation-template.xlsx` |
| Formula nodes behind it | 21 |
| Free inputs | 48 |
...
| | |
| --- | --- |
| Formula cells in this target's cone | 4 |
| Cells whose value varied across sampling | **4 (100%)** |
