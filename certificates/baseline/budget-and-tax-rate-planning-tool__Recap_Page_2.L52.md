# Equivalence certificate — `budget-and-tax-rate-planning-tool::Recap Page 2.L52`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Recap Page 2.L52` |
...
| | |
| --- | --- |
| Formula cells in this target's cone | 8 |
| Cells whose value varied across sampling | **4 (50%)** |
| Cells constant for this input domain | 4 |
