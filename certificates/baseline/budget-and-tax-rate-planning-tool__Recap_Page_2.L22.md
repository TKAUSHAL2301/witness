# Equivalence certificate — `budget-and-tax-rate-planning-tool::Recap Page 2.L22`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Recap Page 2.L22` |
| Workbook | `budget-and-tax-rate-planning-tool.xlsx` |
| Formula nodes behind it | 118 |
| Free inputs | 13 |
...
| Cells whose value varied across sampling | **2 (67%)** |
