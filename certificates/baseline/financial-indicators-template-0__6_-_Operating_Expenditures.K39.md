# Equivalence certificate — `financial-indicators-template-0::6 - Operating Expenditures.K39`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `6 - Operating Expenditures.K39` |
| Workbook | `financial-indicators-template-0.xlsx` |
| Formula nodes behind it | 38 |
| Free inputs | 24 |
