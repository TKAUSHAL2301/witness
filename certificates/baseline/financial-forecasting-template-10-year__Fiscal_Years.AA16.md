# Equivalence certificate — `financial-forecasting-template-10-year::Fiscal Years.AA16`

## Verdict: **NOT EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Fiscal Years.AA16` |
| Workbook | `financial-forecasting-template-10-year.xlsx` |
| Formula nodes behind it | 51 |
| Free inputs | 1 |
...
- Excel returned: `50951`
- The port returned: `None`
- Difference: **-50,951.00**
...
```json
{
  "Fiscal Years!B16": "2014-06-30 00:00:00"
}
```
...
| | |
| --- | --- |
| Formula cells in this target's cone | 25 |
| Cells whose value varied across sampling | **25 (100%)** |
