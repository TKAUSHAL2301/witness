# Equivalence certificate — `financial-forecasting-template-5-year::Available Funds.N53`

## Verdict: **NOT EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Available Funds.N53` |
...
- Excel returned: `47664`
- The port returned: `None`
- Difference: **-47,664.00**
