# Equivalence certificate — `financial-forecasting-template-5-year::Available Funds.N48`

## Verdict: **NOT EQUIVALENT**

| | |
| --- | --- |
| Target cell | `Available Funds.N48` |
| Workbook | `financial-forecasting-template-5-year.xlsx` |
| Formula nodes behind it | 25 |
| Free inputs | 1 |
...
- Excel returned: `47665`
- The port returned: `None`
- Difference: **-47,665.00**
...
```json
{
  "Fiscal Years!B13": "2019-07-01 00:00:00"
}
```
...
| | |
| --- | --- |
| Formula cells in this target's cone | 12 |
| Cells whose value varied across sampling | **12 (100%)** |
