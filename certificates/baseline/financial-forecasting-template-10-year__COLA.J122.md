# Equivalence certificate — `financial-forecasting-template-10-year::COLA.J122`

## Verdict: **CERTIFIED EQUIVALENT**

| | |
| --- | --- |
| Target cell | `COLA.J122` |
| Workbook | `financial-forecasting-template-10-year.xlsx` |
| Formula nodes behind it | 104 |
| Free inputs | 56 |
...
| | |
| --- | --- |
| Formula cells in this target's cone | 33 |
| Cells whose value varied across sampling | **30 (91%)** |
| Cells constant for this input domain | 3 |

Cells that never varied — effectively constants over this domain:

- `COLA!J112`
- `Position Control!J554`
- `Position Control!J536`
